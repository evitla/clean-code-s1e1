...
var createNewTaskElement=function(taskString){
  ...
  label.className="todo__list-item-task";

  //Each elements, needs appending
  checkBox.type="checkbox";
  checkBox.className="checkbox"
  editInput.type="text";
  editInput.className="todo__list-item-input";

  editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
  editButton.className="primary-btn edit-btn";

  deleteButton.className="primary-btn delete-btn";
...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("todo__list-item_edit");
  //If class of the parent is .editmode
  if(containsClass){

      //switch to .editmode
      //label becomes the inputs value.
      editInput.classList.add("todo__list-item-input");
  ...
  listItem.classList.toggle("todo__list-item_edit");
};
